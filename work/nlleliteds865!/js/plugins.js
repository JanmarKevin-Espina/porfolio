$(document).ready(function(){
	...
	// 	} else{
	// 		$('.main_logo').insertBefore('.header_wrapper');
	// 		$('#nav_area').insertAfter('.header_wrapper');
	// 	}
	// }
	...
	function swap_this(){
		...
		if(window_width <=1000){
			$('.footer_info').insertBefore('.footer_btm_con');
			$('.footer_top_con').insertBefore('.footer_nav');
		}else {
			$('.footer_info').insertBefore('.footer_nav');
			$('.footer_top_con').insertBefore('.footer_btm_con');
		}
	}
